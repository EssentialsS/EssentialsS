...
public class EssentialsSMain implements EssentialsSAPI {
    ...
    private void registerEvents() {
        Object muteListener;
        try {
            Class<?> muteListenerClass = Class.forName("org.essentialss.listeners.chat.MuteListener");
            muteListener = muteListenerClass.getConstructor().newInstance();
        } catch (ClassNotFoundException | InvocationTargetException | InstantiationException | IllegalAccessException | NoSuchMethodException e) {
            throw new RuntimeException("Api module not found", e);
        }
        ...
        eventManager.registerListeners(this.container, muteListener);
        ...
        try {
            Class<?> chatListenerClass = Class.forName("org.essentialss.listeners.chat.ChatListener");
            Object chatListenerObject = chatListenerClass.getConstructor().newInstance();
            eventManager.registerListeners(this.container, chatListenerObject);
