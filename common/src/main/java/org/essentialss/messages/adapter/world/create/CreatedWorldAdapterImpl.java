package org.essentialss.messages.adapter.world.create;
...
public class CreatedWorldAdapterImpl extends AbstractMessageAdapter implements CreatedWorldMessageAdapter {

    private static final SingleDefaultConfigValueWrapper<Component> CONFIG_VALUE;

    static {
        ComponentConfigValue messageConfigValue = new ComponentConfigValue("world", "create", "Created");
        Component defaultMessage = Component.text("Created world of " + SPlaceHolders.WORLD_NAME.formattedPlaceholderTag() + ".");
        CONFIG_VALUE = new SingleDefaultConfigValueWrapper<>(messageConfigValue, defaultMessage);
    }

    public CreatedWorldAdapterImpl() {
        super(CONFIG_VALUE);
    }
