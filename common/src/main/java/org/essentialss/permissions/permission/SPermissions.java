...
public enum SPermissions implements SPermission {
    ...
    HOME_CREATE_OTHER("essentialss.home.create.other"),
    HOME_TELEPORT_SELF("essentialss.home.teleport.self", true),
    HOME_TELEPORT_OTHER("essentialss.home.teleport.other"),
    HOME_REMOVE_SELF("essentialss.home.remove.self", true),
