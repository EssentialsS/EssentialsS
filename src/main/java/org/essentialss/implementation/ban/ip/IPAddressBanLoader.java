...
public class IPAddressBanLoader implements SerializablePart<IPBanData> {
    ...
    @Override
    public void saveTo(@NotNull ConfigurationNode node, @Nullable IPBanData obj) throws ConfigurateException {
        if (null == obj) {
            node.set(null);
            return;
        }
    ...
    @Override
    public @Nullable IPBanData loadFrom(@NotNull ConfigurationNode node) throws ConfigurateException {
