...
public class YouAreNowUnmutedMessageAdapterImpl implements YouAreNowUnmutedMessageAdapter {

    private static final SingleDefaultConfigValueWrapper<Component> CONFIG_VALUE = new SingleDefaultConfigValueWrapper<>(
            new ComponentConfigValue("player", "command", "mute", "YouAreNowUnmuted"),
            Component.text("%" + SPlaceHolders.MUTE_TYPE.placeholderTag() + "'s% can now be spoken"));
