...
public class BackToKeyboardMessageAdapterImpl extends AbstractEnabledMessageAdapter implements BackToKeyboardMessageAdapter {
    private static final SingleDefaultConfigValueWrapper<Component> CONFIG_VALUE;

    static {
        ComponentConfigValue messageConfigValue = new ComponentConfigValue("player", "interaction", "backToKeyboard", "Message");
        Component defaultValue = Component.text(SPlaceHolders.PLAYER_NICKNAME.formattedPlaceholderTag() + " is back");
